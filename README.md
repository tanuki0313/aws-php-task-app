...
### 1. セキュリティグループの設定
- **問題**: ブラウザとwebサーバーが接続できず、ブラウザにwebコンテンツを表示できない。
- **原因**: EC2インスタンスのセキュリティグループのインバウンドルールのタイプがSSHのみでHTTPの設定がされていなかった。
- **解決**: セキュリティグループにブラウザとwebサーバーがやり取りできるよう、HTTPの設定を追加した
